...
$(document).ready(function () {
    ...
    function addCrop() {
        ...
        const cropImage = $('#cropImage').prop('files')[0]?.name || '';
    ...
    function editCrop(index) {
        ...
        submitButton.text("Update Crop").off('click').on('click', function (e) {
            e.preventDefault();
            updateCrop(index);
        });
    }
    ...
    function updateCrop(index) {
        ...
        crops[index] = {
            ...
            cropImage: $('#cropImage').prop('files')[0]?.name || crops[index].cropImage,
        ...
        // Revert "Update" button to "Add" button
        const submitButton = $('.add-btn');
        submitButton.text("Add Crop").off('click').on('click', function (e) {
            e.preventDefault();
            addCrop();
        });
    }
